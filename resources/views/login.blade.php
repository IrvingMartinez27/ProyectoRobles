        ...
        <section class="hidden md:flex md:w-1/2 bg-[#1a1c1c] items-center justify-center p-12 overflow-hidden relative">
            ...
            <div class="relative z-10 text-white flex flex-col gap-8 max-w-sm w-full">
                <div>
                    ...
                    <div class="text-5xl font-black tracking-tight">Qui<span class="text-[#1737c8]">vex</span></div>
                    <p class="text-white/40 text-sm mt-3 leading-relaxed">Tu sistema de punto de venta para tiendas deportivas mexicanas.</p>
                </div>
        ...
        <section class="flex-1 flex flex-col justify-center items-center px-6 pt-24 pb-12 bg-white">
            <div class="w-full max-w-md flex flex-col gap-8">
                ...
                <div class="flex flex-col gap-2">
                    <h2 class="text-3xl font-black tracking-tight text-on-surface uppercase">Iniciar sesión</h2>
