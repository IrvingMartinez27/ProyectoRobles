    ...
    <section class="flex-1 flex flex-col h-full overflow-y-auto">
        ...
        <div class="flex-1 flex items-center justify-center px-6 py-4">
            <div class="w-full max-w-sm flex flex-col gap-4">
                ...
                @if ($errors->any())
                <div class="bg-red-50 border border-red-200 rounded-xl px-4 py-3 fade-in">
                ...
                <form action="/register" method="POST" class="flex flex-col gap-3">
                    ...
                    <div class="flex flex-col gap-1.5 fade-in delay-1">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div class="plan-card tilt-card selected border-2 border-[#1737c8] rounded-xl p-3 relative"
                                ...
                                <ul class="mt-1.5 space-y-0.5">
                                    <li class="text-[9px] text-[#5e5e5e] flex items-center gap-1"><span class="material-symbols-outlined text-[#1737c8] text-[10px]">check</span>20 productos</li>
                            ...
                            <div class="plan-card tilt-card border-2 border-gray-200 rounded-xl p-3 relative bg-[#1737c8]"
                    ...
                    <div class="fade-in delay-2">
                        ...
                        <input name="name" value="{{ old('name') }}"
                               class="w-full bg-transparent border border-gray-300 rounded-xl px-3 py-2 text-sm focus:border-primary focus:ring-2 focus:ring-primary/30 outline-none"
                    ...
                    <button type="submit" id="btn-registro"
                            class="w-full bg-primary text-white font-bold py-3 rounded-xl uppercase tracking-widest text-xs fade-in delay-5">
                        Crear cuenta gratis
                    </button>
                </form>

                <div class="flex items-center gap-3 fade-in delay-5">
                    <div class="flex-1 h-px bg-gray-200"></div>
                    <span class="text-[10px] font-bold uppercase tracking-widest text-gray-400">o continúa con</span>
                    <div class="flex-1 h-px bg-gray-200"></div>
                </div>

                <div class="flex gap-3 fade-in delay-5">
                ...
                <p class="flex items-center justify-center gap-1.5 text-[10px] text-gray-400 pb-2 fade-in delay-5">
